            ...
            <article class="column-9">
                ...
                <div class="column-12">
                    ...
                    <form id="shopform" method="post" action="cart.php">
                        ...
                        <div class="flex-row">
                            ...
                            <div class="shop-item">
                                ...
                                <div class="swap-container">
                                    ...
                                    <span>Add to cart: <input  id="s2amount" oninput="calculateTotal();calculateSubTotal(this,22.50);saveCart(this)" type="number" name="plm[s2]" min="0" max="5" value="0"></span>
                                    <a class="button moreinfo" href="#">More Info</a>
                                    ...
                                    <div class="back">
                                        ...
                                        <div class="details">
                                            ...
                                            The coming-of-age comedy returns having received critical acclaim in Australia and the USA, where it was hailed as “best new comedy”. The award-winning Please Like Me is back for a second season, written by and starring Josh Thomas.</div>
                            ...
                            <div class="shop-item">
                                ...
                                <div class="swap-container">
                                    ...
                                    <span>Add to cart: <input  id="s3amount" oninput="calculateTotal();calculateSubTotal(this,26.75);saveCart(this)" type="number" name="plm[s3]" min="0" max="5" value="0"></span>
                                    <a class="button moreinfo" href="#">More Info</a>
                                    ...
                                    <div class="back">
                                        ...
                                        <div class="details">
                                            <h4>Hilariously awkward</h4>Kicking off with a half-hour romcom and ending with an unforgettable family Christmas lunch, this season is filled with food, sex, drugs, dancing, singing, secrets and a transgender
                                            chicken.
                                        </div>
                        ...
                        <div class="flex-row">
                            <button name="media" value="DVD" type="submit" class="button checkout column-1">Buy DVDs</button>
                            <button name="media" value="BluRay" type="submit" class="button checkout column-1">Buy BluRay</button>
                        </div>
                    </form>
                </div>
            </article>
