            ...
            <article class="column-9 flex-responsive">
                ...
                <div class="flex-row">
                    <form action="submit.php" id="form1" formmethod="post">
                        <div class="flex-row">
                            <div class="shop-item column-3">Please Like me season 1
                            ...
                            <div class="shop-item column-3">Please Like me season 2
                                <div class="swap-container">
                                    <a class="button moreinfo" href="#">More Info</a>
                            ...
                            <div class="shop-item column-3">Please Like me season 3
                                <div class="swap-container">
                                    <a class="button moreinfo" href="#">More Info</a>
                            ...
                            <div class="shop-item column-3">Please Like Me Season 4
                                <div class="swap-container">
                                    <a class="button moreinfo" href="#">More Info</a>
                                    <div class="front">
                                        <ul>
