                            ...
                            <div class="flex-row">
                                <div class="shop-item column-6">
                                    ...
                                    <div class="swap-container">
                                        ...
                                        <div class="back">
                                            ...
                                            <p>$20</p>
                                            <span>Add to cart: $20 * <input type="number" name="plm[s1]" min="0" max="5" value="0"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="shop-item column-6">
                                    ...
                                    <div class="swap-container">
                                        ...
                                        <div class="back">
                                            ...
                                            <details>
                                                ...
                                                The coming-of-age comedy returns having received critical acclaim in Australia and the USA, where it was hailed as “best new comedy”. The award-winning Please Like Me is back for a second season, written by
                                                and starring Josh Thomas.</details>
                                            <p>$25</p>
                                            <span>Add to cart: $25 * <input type="number" name="plm[s2]" min="0" max="5" value="0"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="shop-item column-6">
                                    ...
                                    <div class="swap-container">
                                        ...
                                        <div class="back">
                                            <!-- Original text below sourced for educational purposes: https://shop.abc.net.au/products/please-like-me-dvd-s1 -->
                                            <details><summary>Hilariously awkward</summary>Kicking off with a half-hour romcom and ending with an unforgettable family Christmas lunch,
                                                this season is filled with food, sex, drugs, dancing, singing, secrets and a transgender chicken.</details>
                                            <p>$33</p>
                                            <span>Add to cart: $33 * <input type="number" name="plm[s3]" min="0" max="5" value="0"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="shop-item column-6">
